...
export function HeroSection() {
  return (
    <section className="relative mb-10 flex w-full flex-1 items-center justify-center bg-[radial-gradient(circle_at_top,rgba(99,102,241,0.25),transparent_60%)] py-16 text-center">
      ...
      <div
        ...
        aria-hidden="true"
      />
      <div className="relative z-10 mx-auto mt-10 flex w-full max-w-4xl flex-col items-center gap-6">
