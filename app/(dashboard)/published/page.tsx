        ...
        <div className="space-y-8 animate-in fade-in-50 duration-500">
            ...
            <Tabs defaultValue="interviews" className="space-y-6">
                <TabsList className="bg-transparent p-0 border-b border-white/10 w-full justify-start h-auto rounded-none">
                    ...
                    <TabsTrigger 
                        value="courses" 
                        className="rounded-none border-b-2 border-transparent data-[state=active]:border-emerald-500 data-[state=active]:bg-transparent px-0 pb-3 pt-2 font-medium text-muted-foreground data-[state=active]:text-emerald-400 hover:text-white transition-colors"
                    >
                        Courses
                    </TabsTrigger>
                </TabsList>
