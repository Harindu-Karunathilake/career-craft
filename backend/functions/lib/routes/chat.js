...
router.post("/", async (req, res) => {
    try {
        ...
        const generateInterviewSchema = zod_1.z.object({
            role: zod_1.z.string().describe("The target job role for the interview"),
            experience: zod_1.z.string().describe("The experience level of the candidate"),
            topic: zod_1.z.string().optional().describe("The specific focus topic for the interview"),
        });
